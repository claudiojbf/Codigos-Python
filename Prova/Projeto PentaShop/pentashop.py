...
def cadastro():
        questao = input("De qual arquivo Voce gostaria de Criar?(Masculino(M) Feminino(F) Infantil (F) Acessorio(A))").upper().strip()
        if questao == "M":
            cadastro_padrao("masculino")
        elif questao == "F":
            cadastro_padrao("feminino")
        elif questao == "I":
            cadastro_padrao("infantil")
        elif questao == "A":
            categoria = input("Qual a categoria do acessorio?")
            nome = input("Qual o nome do acessorio?")
            preco = float(input("Qual o preco do acessorio?".format(".2f")))
            print("="*20)
            print("Cadastro Realizado com sucesso")
            print("="*20)
